...
//   }
//
//   // late double congestion;
//   // late int realtimeWaitingTime;
//   // late int numberOfWaitingCars;
...
//   //       _serverConnectTimer.cancel();
//   //     } catch (e) {
//   //       debugPrint('timer cancel error on try: ${e}');
//   //     }
//   //     debugPrint('error rt page when connect ${e}');
//   //   }
//   //   // _channel!.sink.add('ping');
//   //   _channel!.stream.listen(
//   //     (dynamic message) {
//   //       // debugPrint('message in realtime: $message');
//   //       Map<String, dynamic> dataMap = jsonDecode(jsonDecode(message));
//   //       debugPrint('datamap : $dataMap');
//   //       congestion = dataMap['congestion'] as double;
//   //       realtimeWaitingTime = dataMap['waiting_time'];
//   //       numberOfWaitingCars = dataMap['num_of_waiting_cars'];
//   //       // dataMap['electric_charging_waiting_cnt'];
//   //       // dataMap['car_interior_wash_cnt'];
//   //     },
//   //     onDone: () {
//   //       debugPrint('ws channel closed');
//   //       if (mounted) {
//   //         debugPrint('mounted rt page');
//   //         setState(() {
//   //           _isReady = false;
//   //         });
...
//           //       debugPrint('snapshot data-> ${snshot.data}');
//           //
//           //       if (!snshot.hasData) {
//           //         return CircularProgressIndicator();
//           //       }
//           //       Map<String, dynamic> dataMap =
//           //           jsonDecode(jsonDecode(snshot.data));
//           //       // debugPrint('data map : ${dataMap}');
//           //       // debugPrint(
//           //       //     '${dataMap['congestion'].runtimeType}, ${dataMap['waiting_time'].runtimeType},'
//           //       //     '${dataMap['num_of_waiting_cars'].runtimeType}');
//           //
//           //       double congestion = dataMap['congestion'];
//           //       int realtimeWaitingTime = dataMap['waiting_time'];
//           //       int numberOfWaitingCars = dataMap['num_of_waiting_cars'];
//           //       _channel!.sink..add('ping');
//           //       // _channel!.debugPrint('sinked');
//           //       // if (!snshot.hasData) {
//           //       //   debugPrint("Waiting");
